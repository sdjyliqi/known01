...
var EnterpriseBasicModel DsisEnterpriseBasic
...
func (t DsisEnterpriseBasic) GetItems(engine *xorm.Engine) ([]*DsisEnterpriseBasic, error) {
	var items []*DsisEnterpriseBasic
